...
\begin{tabular}[c]{@{}l@{}}Kendall's Tau \\ for GPT-3.5 Judge\end{tabular} & 0.89& 0.94& 0.67& \textbf{0.94}  & 0.94& 0.89& 0.78& \textbf{0.78}& 0.83& {0.89}& {0.83}  & \textbf{0.94}\\ \midrule
\begin{tabular}[c]{@{}l@{}}Kendall's Tau \\ for ARES \end{tabular} & \textbf{0.94}  & \textbf{1.0}& \textbf{0.94}  & \textbf{0.94}  & \textbf{1.0}& \textbf{1.0}& \textbf{0.89}  & \textbf{0.78}  & \textbf{0.94}  & {0.89}  & {0.83}  & {0.89}  \\ \midrule
\begin{tabular}[c]{@{}l@{}}RAGAS \\ Accuracy\end{tabular} &  31.4\% &  71.2\% & 17.2\% & 76.0\%  &36.4\%&  77.8\% &23.7\%& 69.2\%&  16.1\% &  75.0\% &  15.0\% &  72.8\%\\ \midrule
\begin{tabular}[c]{@{}l@{}}GPT-3.5 Judge \\ Accuracy \end{tabular} & 73.8\%& 95.5\%& 75.3\%& 71.6\%& 84.3\%& 85.2\%& 60.4\%& 59.6\%& 72.4\%& 60.3\%& 81.0\%& 65.8\% \\ \midrule
\begin{tabular}[c]{@{}l@{}} ARES  \\ Accuracy \end{tabular} & 79.3\%& 97.2\%& 92.3\%& 81.3\%& 85.7\%& 96.1\%& 88.4\%& 78.5\%& 85.8\%& 82.7\%& 67.8\%& 92.3\% \\ \bottomrule 
\end{tabular}
\caption{\textbf{ARES Ranking with Fine-tuned LLM Judges vs. RAGAS and GPT-3.5 Judge}: 
For scoring context relevance and answer relevance (C.R. and A.R. in the table, respectively), we compare ARES with our fine-tuned LLM judges to RAGAS, the automated RAG scoring framework, and a few-shot GPT-3.5 judge.
...
We selected GPT-3.5 instead of GPT-4 due to the high financial costs of running GPT-4 over the tens of thousands of queries, documents, and answers for each dataset; the lower financial costs required to run. %
